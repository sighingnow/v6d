...
#ifndef MODULES_FUSE_ADAPTORS_CSV_H_
#define MODULES_FUSE_ADAPTORS_CSV_H_
...
std::shared_ptr<arrow::Buffer> csv_view(std::shared_ptr<vineyard::Table>& df);
...
#endif  // MODULES_FUSE_ADAPTORS_CSV_H_
